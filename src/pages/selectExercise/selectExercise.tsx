...
export default function SelectExercise({
    ...
    return (
        <main className="flex flex-col gap-lg text-center2">
            ...
            <h1 className="mt-md mb-sm text-white">Available Exercises</h1>
            ...
            <div className="grid grid-cols-3 gap-lg">
                {available.map((exercise) => (
                    <Link
                        ...
                        className="bg-primary-500 text-black text-center shadow p-lg rounded border-2 border-transparent transition ease-out duration-200 hover:bg-primary-700 hover:text-black hover:scale-105 hover:border-black"
                    >
